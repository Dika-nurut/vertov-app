  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-[color:var(--color-bg)] data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 border-2 border-[color:var(--color-line)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
          side === 'right' &&
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-[var(--radius-sm)] focus:outline-none focus:border-[color:var(--color-accent)] focus:shadow-[3px_3px_0_0_var(--color-shadow)] disabled:pointer-events-none">
          <X className="h-4 w-4" />
